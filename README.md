...
│
├── pipeline/                  # Auto-generated by ADF (Pipeline JSON)
├── linkedService/             # Auto-generated by ADF (Linked Service JSON)
│
├── notebooks/                 # Databricks PySpark Code
│   ├── 01_test_connection.py
│   ├── 02_generate_load_bronze.py
│   ├── 03_validate_bronze.py
│   ├── 04_bronze_to_silver_cdc.py
│   ├── 05_simulate_new_batch.py
│   ├── 06_optimize_benchmark.py
│   ├── 07_reconciliation.py
│   └── 08_silver_to_gold.py
│
├── proofs/                    # Screenshots proving the project works
│   ├── 1_adf_pipeline_canvas.png
│   ├── 2_adf_successful_run.png
│   ├── 3_databricks_workflow_job.png
│   ├── 4_reconciliation_results.png
│   ├── 5_benchmark_33_percent.png
│   └── 6_synapse_serverless_query.png
│
